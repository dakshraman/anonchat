...
new class extends Component
{
    ...
    {
        // Only load messages from the session (e.g., "Chat ended")
        ...
        <div class="h-100 d-flex flex-column align-items-center justify-content-center py-5">
            @if ($activeSession)
                <div class="glass-card w-100 p-5 text-center position-relative overflow-hidden" style="border-radius: 3rem;">
                    ...
                    <p class="text-secondary mb-4 mx-auto" style="max-width: 300px;">Jump back in and continue the conversation.</p>
                    <a href="{{ route('chat', $activeSession->id) }}" wire:navigate class="btn glass-button px-5 py-3 fs-5">
                        Join Conversation
                    </a>
                </div>
            @else
                <div class="glass-card w-100 p-5 text-center position-relative overflow-hidden" style="border-radius: 3rem;">
                    <div class="position-relative mb-5 mx-auto" style="width: 120px; height: 120px;">
                        <div class="glass-card d-flex align-items-center justify-content-center p-3 h-100 w-100 position-relative z-1" style="border-radius: 2rem;">
                    ...
                    <h2 class="h1 fw-bold text-white mb-3">{{ $isWaiting ? 'Searching...' : 'Ready?' }}</h2>
                    <p class="text-secondary mb-5 mx-auto" style="max-width: 400px;">
                    ...
                    @if ($isWaiting)
                        <button wire:click="stopSearching" wire:loading.attr="disabled" class="btn btn-outline-danger px-5 py-3 fs-4 d-flex align-items-center justify-content-center gap-3 mx-auto" style="border-radius: 1rem; border-width: 2px;">
                            <span wire:loading.remove wire:target="stopSearching">
                    ...
                    @else
                        <button wire:click="findMatch" wire:loading.attr="disabled" class="btn glass-button px-5 py-3 fs-4 d-flex align-items-center justify-content-center gap-3 mx-auto">
                            <span wire:loading.remove wire:target="findMatch">
